...
Resolve the still-open blocking questions above before promoting their corresponding tickets to Ready. OQ-038 and OQ-039 are resolved for their original scopes, ST-001-06 through ST-001-08 are Done on `master`, and ST-001-09 is Done on its feature branch with green CI run #464. ST-001-10 is the next dependency-ordered ticket and remains Draft pending its own specification.
