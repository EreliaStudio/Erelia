...
Resolve the still-open blocking questions above before promoting their corresponding tickets to Ready. OQ-038 and OQ-039 are resolved, and ST-001-06 through ST-001-08 are Done on `master`. ST-001-09 is the next dependency-ordered ticket but remains Blocked by its Server-specific lifecycle/failure specification.
