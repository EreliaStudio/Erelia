...
- Server Chunk terminal Success/Failure response;
...
- [OQ-038](../../OPEN_QUESTIONS/OQ-038-CHUNK-REQUEST-STREAMING.md) — Resolved for the original ST-001-08 contract; ST-001-09 implements the later terminal Response and diagnostic refinements;
...
Resolve the still-open blocking questions above before promoting their corresponding tickets to Ready. OQ-038 and OQ-039 are resolved for their original scopes, ST-001-06 through ST-001-08 are Done on `master`, and ST-001-09 is Done on its feature branch with green CI run #475. ST-001-10 is the next dependency-ordered ticket and remains Draft pending its own specification.
