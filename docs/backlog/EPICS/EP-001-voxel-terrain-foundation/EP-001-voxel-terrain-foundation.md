...
- [OQ-038](../../OPEN_QUESTIONS/OQ-038-CHUNK-REQUEST-STREAMING.md) — Resolved for the original ST-001-08 contract; ST-001-09 later refines terminal Response entries and plans a generic diagnostic mechanism, with remaining details tracked by ST-001-09;
...
Resolve the still-open blocking questions above before promoting their corresponding tickets to Ready. OQ-038 and OQ-039 are resolved for their original scopes, and ST-001-06 through ST-001-08 are Done on `master`. ST-001-09 is the next dependency-ordered ticket but remains Blocked by the refined Response/diagnostic details, Collection-batch failure reconciliation, batching policy, and Server lifecycle/failure specification.
