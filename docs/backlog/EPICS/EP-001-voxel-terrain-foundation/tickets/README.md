...
| [ST-001-05 — Voxel::Volume Message serialization](ST-001-05-voxel-volume-message-serialization.md) | **Ready** | ST-001-02, ST-001-03; OQ-037 resolved |
...
ST-001-01 through ST-001-04 are merged into `master`. ST-001-05 is the active dependency-ordered implementation ticket.
