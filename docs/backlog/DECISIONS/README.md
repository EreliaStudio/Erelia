...
| DR-019 | [Immutable shared Volume content and Chunk Collection/Provider contract](DR-019-IMMUTABLE-VOLUME-CHUNK-COLLECTION-PROVIDER.md) | Resolved | Core voxel ownership, asynchronous Chunk lifetime/acquisition, Server/Client Chunk storage | DR-012 Volume ownership/copy details; DR-017 decode-reuse detail |
| DR-020 | [Headless asynchronous task infrastructure prototype](DR-020-HEADLESS-ASYNC-TASK-INFRASTRUCTURE.md) | Resolved | Core async tasks, WorkerPool, ThreadSafeSet, Singleton | — |
| DR-021 | [Start logical Server nodes as remote processes](DR-021-REMOTE-SERVER-NODES-FROM-FIRST-IMPLEMENTATION.md) | Resolved | Server topology, node deployment, runtime configuration, tooling | DR-016 initial LocalNode deployment choice |
| DR-022 | [Batched Chunk protocol wire contract](DR-022-CHUNK-PROTOCOL-WIRE-CONTRACT.md) | Resolved | Core Chunk protocol, Server/Client interoperability | DR-014 detailed protocol semantics |
