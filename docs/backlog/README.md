...
5. OPEN-REQUESTS.md — external dependency issues with concrete Erelia follow-up work.
...
- OPEN-REQUESTS.md — external dependency requests and the Erelia cleanup to perform when they resolve.
