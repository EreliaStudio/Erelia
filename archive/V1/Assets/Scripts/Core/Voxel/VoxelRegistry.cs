...
namespace Erelia.Core.Voxel
{
	...
	public sealed class VoxelRegistry : ScriptableObject
	{
		[Serializable]
		public struct Entry
		{
			...
			public Erelia.Core.Voxel.VoxelDefinition Definition;
		}

		[SerializeField] private List<Entry> entries = new List<Entry>();

		[NonSerialized] private Dictionary<int, Erelia.Core.Voxel.VoxelDefinition> registeredDefinition;
		...
		{
			registeredDefinition = new Dictionary<int, Erelia.Core.Voxel.VoxelDefinition>();
		...
		public void Add(int id, Erelia.Core.Voxel.VoxelDefinition definition)
		{
			if (definition == null)
			{
		...
		public bool TryGet(int id, out Erelia.Core.Voxel.VoxelDefinition definition)
		{
			EnsureRegistry();
