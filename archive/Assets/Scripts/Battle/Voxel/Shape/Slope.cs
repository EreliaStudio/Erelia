	...
	public class Slope : Erelia.Battle.Voxel.Mask.Shape
	{
		protected override Dictionary<Erelia.Core.Voxel.FlipOrientation, List<Erelia.Core.Voxel.Face>> ConstructMaskFaces()
		{
			...
			Erelia.Core.Voxel.Face slope = Erelia.Core.Voxel.Utils.Geometry.CreateRectangle(
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, 0f + maskOffset, 0f), TileUV = new Vector2(0f, 0f) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, 0f + maskOffset, 0f), TileUV = new Vector2(1f, 0f) },
