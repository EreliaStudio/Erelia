...
namespace Core.Voxel.Model
{
	...
	public class CardinalPointSet
	{
		...
		public CardinalPointSet(Vector3 positiveX, Vector3 negativeX, Vector3 positiveZ, Vector3 negativeZ, Vector3 stationary)
		{
		...
		public Vector3 Get(CardinalPoint entryPoint)
		{
			switch (entryPoint)
			{
				case CardinalPoint.PositiveX:
					return positiveX;
				case CardinalPoint.NegativeX:
					return negativeX;
				case CardinalPoint.PositiveZ:
					return positiveZ;
				case CardinalPoint.NegativeZ:
					return negativeZ;
				case CardinalPoint.Stationary:
					return stationary;
				default:
					return stationary;
			}
