...
{
	public class KeyboardMotionController : MonoBehavior
	{
		//This class is suppose to manage the ZQSD/QWSD movement control, with additionnal A and E for rotation
	}
}
