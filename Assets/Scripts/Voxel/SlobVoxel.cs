...
public class SlobVoxel : Voxel
{
    ...
    protected override Dictionary<OuterShellPlane, VoxelFace> ConstructOuterShellFaces()
    {
        ...
        VoxelFace posX = GeometryUtils.CreateRectangle(
            ...
            new GeometryUtils.Vertex { Position = new Vector3(1f, 0.5f, 0f), UV = uvD });
        ...
        VoxelFace negZ = GeometryUtils.CreateRectangle(
            ...
            new GeometryUtils.Vertex { Position = new Vector3(1f, 0.5f, 0f), UV = uvC },
            new GeometryUtils.Vertex { Position = new Vector3(0f, 0.5f, 0f), UV = uvD });
