...
namespace Erelia.Battle.Voxel.ShapeType
{
	...
	public class Stair : Erelia.Battle.Voxel.Mask.Shape
	{
		...
		protected override Dictionary<Erelia.Core.Voxel.FlipOrientation, List<Erelia.Core.Voxel.Face>> ConstructMaskFaces()
		{
			...
			Erelia.Core.Voxel.Face upperTop = Erelia.Core.Voxel.Utils.Geometry.CreateRectangle(
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, upperY, StepDepth), TileUV = new Vector2(0f, uvStep * 2f) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(right, upperY, StepDepth), TileUV = new Vector2(1f, uvStep * 2f) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(right, upperY, 1f), TileUV = new Vector2(1f, 1f) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, upperY, 1f), TileUV = new Vector2(0f, 1f) });
			faces.Add(upperTop);

			float riserZ = StepDepth - riserZOffset;
			Erelia.Core.Voxel.Face upperRiser = Erelia.Core.Voxel.Utils.Geometry.CreateRectangle(
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, lowerY, riserZ), TileUV = new Vector2(0f, uvStep) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(right, lowerY, riserZ), TileUV = new Vector2(1f, uvStep) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(right, upperY, riserZ), TileUV = new Vector2(1f, uvStep * 2f) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, upperY, riserZ), TileUV = new Vector2(0f, uvStep * 2f) });
			faces.Add(upperRiser);

			Erelia.Core.Voxel.Face lowerTop = Erelia.Core.Voxel.Utils.Geometry.CreateRectangle(
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, lowerY, 0f), TileUV = new Vector2(0f, 0f) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, lowerY, 0f), TileUV = new Vector2(1f, 0f) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, lowerY, StepDepth), TileUV = new Vector2(1f, uvStep) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, lowerY, StepDepth), TileUV = new Vector2(0f, uvStep) });
			faces.Add(lowerTop);
