...
namespace Erelia.BattleVoxel.Mesherutils
{
	public static class CardinalPointSetCache
	{
		private readonly struct Key : IEquatable<Key>
		{
			...
			public Key(CardinalPointSet entryPoints, VoxelKit.Orientation orientation, VoxelKit.FlipOrientation flipOrientation)
			{
		...
		private static CardinalPointSet TransformCardinalPoints(
			...
			VoxelKit.FlipOrientation flipOrientation)
		{
			Vector3 posX = VoxelKit.Utils.Geometry.TransformPoint(source.PositiveX, orientation, flipOrientation);
			Vector3 negX = VoxelKit.Utils.Geometry.TransformPoint(source.NegativeX, orientation, flipOrientation);
			Vector3 posZ = VoxelKit.Utils.Geometry.TransformPoint(source.PositiveZ, orientation, flipOrientation);
			Vector3 negZ = VoxelKit.Utils.Geometry.TransformPoint(source.NegativeZ, orientation, flipOrientation);
			Vector3 stationary = VoxelKit.Utils.Geometry.TransformPoint(source.Stationary, orientation, flipOrientation);
