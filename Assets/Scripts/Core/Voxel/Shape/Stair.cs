...
{
	[Serializable]
	public class Stair : Erelia.Core.Voxel.Shape
	{
		...
		private List<Erelia.Core.Voxel.Face> ConstructInnerFaces()
		{
			...
			Erelia.Core.Voxel.Utils.SpriteUv.GetSpriteUvRect(spriteStepTop, out Vector2 uvAnchor, out Vector2 uvSize);
			...
			Erelia.Core.Voxel.Face stepTop = Erelia.Core.Voxel.Utils.Geometry.CreateRectangle(
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, StepHeight, 0f), TileUV = uvA },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, StepHeight, 0f), TileUV = uvB },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, StepHeight, StepDepth), TileUV = uvC },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, StepHeight, StepDepth), TileUV = uvD });
			faces.Add(stepTop);

			Erelia.Core.Voxel.Utils.SpriteUv.GetSpriteUvRect(spriteStepRiser, out uvAnchor, out uvSize);
			...
			Erelia.Core.Voxel.Face stepRiser = Erelia.Core.Voxel.Utils.Geometry.CreateRectangle(
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, StepHeight, StepDepth), TileUV = uvA },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, StepHeight, StepDepth), TileUV = uvB },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, 1f, StepDepth), TileUV = uvC },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, 1f, StepDepth), TileUV = uvD });
			faces.Add(stepRiser);
		...
		private Dictionary<AxisPlane, Erelia.Core.Voxel.Face> ConstructOuterShellFaces()
		{
			...
			var posX = new Erelia.Core.Voxel.Face();
			posX.AddPolygon(new List<Erelia.Core.Voxel.Face.Vertex>
			{
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, 0f, 0f), TileUV = new Vector2(u2, v0) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, 0f, StepDepth), TileUV = new Vector2(u1, v0) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, StepHeight, StepDepth), TileUV = new Vector2(u1, v1) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, StepHeight, 0f), TileUV = new Vector2(u2, v1) }
			});
			posX.AddPolygon(new List<Erelia.Core.Voxel.Face.Vertex>
			{
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, 0f, StepDepth), TileUV = new Vector2(u1, v0) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, 0f, 1f), TileUV = new Vector2(u0, v0) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, 1f, 1f), TileUV = new Vector2(u0, v2) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, 1f, StepDepth), TileUV = new Vector2(u1, v2) }
			});
			...
			var negX = new Erelia.Core.Voxel.Face();
			negX.AddPolygon(new List<Erelia.Core.Voxel.Face.Vertex>
			{
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, 0f, 0f), TileUV = new Vector2(u2, v0) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, StepHeight, 0f), TileUV = new Vector2(u2, v1) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, StepHeight, StepDepth), TileUV = new Vector2(u1, v1) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, 0f, StepDepth), TileUV = new Vector2(u1, v0) }
			});
			negX.AddPolygon(new List<Erelia.Core.Voxel.Face.Vertex>
			{
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, 0f, StepDepth), TileUV = new Vector2(u1, v0) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, 1f, StepDepth), TileUV = new Vector2(u1, v2) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, 1f, 1f), TileUV = new Vector2(u0, v2) },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, 0f, 1f), TileUV = new Vector2(u0, v0) }
			});
			faces[AxisPlane.NegX] = negX;

			Erelia.Core.Voxel.Utils.SpriteUv.GetSpriteUvRect(spriteFront, out uvAnchor, out uvSize);
			halfUvSize = new Vector2(uvSize.x, uvSize.y * 0.5f);
			halfUvAnchor = uvAnchor;
			uvA = halfUvAnchor;
			uvB = halfUvAnchor + new Vector2(halfUvSize.x, 0f);
			...
			Erelia.Core.Voxel.Face negZ = Erelia.Core.Voxel.Utils.Geometry.CreateRectangle(
				...
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, StepHeight, 0f), TileUV = uvC },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, StepHeight, 0f), TileUV = uvD });
			...
			Erelia.Core.Voxel.Utils.SpriteUv.GetSpriteUvRect(spriteStepTop, out uvAnchor, out uvSize);
			halfUvSize = new Vector2(uvSize.x, uvSize.y * 0.5f);
			...
			Erelia.Core.Voxel.Face posY = Erelia.Core.Voxel.Utils.Geometry.CreateRectangle(
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(0f, 1f, StepDepth), TileUV = uvA },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, 1f, StepDepth), TileUV = uvB },
				new Erelia.Core.Voxel.Face.Vertex { Position = new Vector3(1f, 1f, 1f), TileUV = uvC },
