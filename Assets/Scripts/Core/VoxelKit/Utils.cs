...
namespace Erelia.Core.VoxelKit.Utils
{
	public static class Geometry
	{
		...
		private static readonly Erelia.Core.VoxelKit.Face FullPosXFace = Erelia.Core.VoxelKit.Utils.Geometry.CreateRectangle(
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 0f, 0f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 0f, 1f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 1f, 1f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 1f, 0f), UV = Vector2.zero });
		private static readonly Erelia.Core.VoxelKit.Face FullNegXFace = Erelia.Core.VoxelKit.Utils.Geometry.CreateRectangle(
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 0f, 0f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 1f, 0f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 1f, 1f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 0f, 1f), UV = Vector2.zero });
		private static readonly Erelia.Core.VoxelKit.Face FullPosYFace = Erelia.Core.VoxelKit.Utils.Geometry.CreateRectangle(
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 1f, 0f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 1f, 0f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 1f, 1f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 1f, 1f), UV = Vector2.zero });
		private static readonly Erelia.Core.VoxelKit.Face FullNegYFace = Erelia.Core.VoxelKit.Utils.Geometry.CreateRectangle(
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 0f, 0f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 0f, 1f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 0f, 1f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 0f, 0f), UV = Vector2.zero });
		private static readonly Erelia.Core.VoxelKit.Face FullPosZFace = Erelia.Core.VoxelKit.Utils.Geometry.CreateRectangle(
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 0f, 1f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 1f, 1f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 1f, 1f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 0f, 1f), UV = Vector2.zero });
		private static readonly Erelia.Core.VoxelKit.Face FullNegZFace = Erelia.Core.VoxelKit.Utils.Geometry.CreateRectangle(
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 0f, 0f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 0f, 0f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(1f, 1f, 0f), UV = Vector2.zero },
			new Erelia.Core.VoxelKit.Utils.Geometry.Vertex { Position = new Vector3(0f, 1f, 0f), UV = Vector2.zero });
		...
		public static Erelia.Core.VoxelKit.Face CreateRectangle(Vertex a, Vertex b, Vertex c, Vertex d)
		{
		...
		public static Erelia.Core.VoxelKit.Face CreateTriangle(Vertex a, Vertex b, Vertex c)
		{
			var face = new Erelia.Core.VoxelKit.Face();
		...
		public static List<Erelia.Core.VoxelKit.Face.Vertex> CreateRectanglePolygon(Vertex a, Vertex b, Vertex c, Vertex d)
		{
			var verts = new List<Erelia.Core.VoxelKit.Face.Vertex>(4)
		{
			new Erelia.Core.VoxelKit.Face.Vertex { Position = a.Position, TileUV = a.UV },
			new Erelia.Core.VoxelKit.Face.Vertex { Position = b.Position, TileUV = b.UV },
			new Erelia.Core.VoxelKit.Face.Vertex { Position = c.Position, TileUV = c.UV },
			new Erelia.Core.VoxelKit.Face.Vertex { Position = d.Position, TileUV = d.UV }
		};
			return verts;
		}

		public static List<Erelia.Core.VoxelKit.Face.Vertex> CreateTrianglePolygon(Vertex a, Vertex b, Vertex c)
		{
		...
		public static bool IsPolygonContained(List<Erelia.Core.VoxelKit.Face.Vertex> polygon, List<Erelia.Core.VoxelKit.Face.Vertex> container, Vector3 normal)
		{
		...
		public static bool IsPolygonContainedInUnion(List<Erelia.Core.VoxelKit.Face.Vertex> polygon, List<List<Erelia.Core.VoxelKit.Face.Vertex>> containers, Vector3 normal)
		{
		...
		public static int OrientationToSteps(Erelia.Core.VoxelKit.Orientation orientation)
		{
			switch (orientation)
			{
		...
		public static Erelia.Core.VoxelKit.Shape.AxisPlane MapWorldPlaneToLocal(Erelia.Core.VoxelKit.Shape.AxisPlane plane, Erelia.Core.VoxelKit.Orientation orientation)
		{
			return RotatePlane(plane, -OrientationToSteps(orientation));
		}

		public static Erelia.Core.VoxelKit.Shape.AxisPlane MapWorldPlaneToLocal(Erelia.Core.VoxelKit.Shape.AxisPlane plane, Erelia.Core.VoxelKit.Orientation orientation, Erelia.Core.VoxelKit.FlipOrientation flipOrientation)
		{
			Erelia.Core.VoxelKit.Shape.AxisPlane rotated = RotatePlane(plane, -OrientationToSteps(orientation));
		...
		public static Erelia.Core.VoxelKit.Face TransformFace(Erelia.Core.VoxelKit.Face face, Erelia.Core.VoxelKit.Orientation orientation, Erelia.Core.VoxelKit.FlipOrientation flipOrientation)
		{
		...
		public static Vector3 TransformPoint(Vector3 point, Erelia.Core.VoxelKit.Orientation orientation, Erelia.Core.VoxelKit.FlipOrientation flipOrientation)
		{
			int steps = OrientationToSteps(orientation);
			Vector3 pivot = new Vector3(0.5f, 0.5f, 0.5f);
			Vector3 local = point;
		...
		public static Erelia.Core.VoxelKit.Face GetFullOuterFace(Erelia.Core.VoxelKit.Shape.AxisPlane plane)
		{
			switch (plane)
			{
				case Erelia.Core.VoxelKit.Shape.AxisPlane.PosX:
		...
		public static bool IsFullFace(Erelia.Core.VoxelKit.Face face, Erelia.Core.VoxelKit.Shape.AxisPlane plane)
		{
			...
			Erelia.Core.VoxelKit.Face fullFace = GetFullOuterFace(plane);
			if (fullFace == null)
			{
				return false;
			}
