...
public sealed class MoveStatusTests : EffectTestBase
{
	...
	public void Apply_MovesTargetAwayFromCaster()
	{
		...
		PlaceUnit(fixture.BattleContext, target, new Vector3Int(2, 1, 1));
		...
		Assert.That(target.BoardPosition, Is.EqualTo(new Vector3Int(3, 1, 1)));
	}
	...
	public void Apply_WithForceTwo_MovesTargetTwoCellsAwayFromCaster()
	{
		...
		Assert.That(target.BoardPosition, Is.EqualTo(new Vector3Int(4, 1, 1)));
	}
